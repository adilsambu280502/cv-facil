...
import {
  ...
  ArrowLeft, ClipboardPaste, LayoutTemplate, Lock, ShieldCheck
} from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30 flex flex-col">
      ...
      <AnimatePresence mode="wait">
        {!hasPaid ? (
          ...
          >
            {/* Frosted Glass Card */}
            <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-2xl border-2 border-slate-100 dark:border-slate-800 rounded-[40px] p-8 lg:p-14 shadow-2xl relative overflow-hidden max-w-xl w-full text-center">
              {/* Glowing effects inside */}
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <button
                  ...
                  className="bg-blue-600 hover:bg-blue-700 text-white font-black rounded-xl py-4 px-8 shadow-lg shadow-blue-600/20 active:scale-95 transition-all text-xs uppercase tracking-wider border-none cursor-pointer"
                >
                  Desbloquear Agora
                </button>
                <button
                  onClick={() => setView("intro")}
                  className="border-2 border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-300 font-black rounded-xl py-4 px-8 active:scale-95 transition-all text-xs uppercase tracking-wider cursor-pointer"
                >
                  Voltar ao Início
                </button>
              </div>

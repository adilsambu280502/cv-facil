# 🚀 Semana 1 — O Grande Lançamento (A História Real)

Esta semana é dedicada a criar impacto e empatia. As pessoas compram histórias antes de comprarem produtos. Ao partilhares a tua jornada pessoal como consultor de currículos e o porquê de teres criado este sistema, estás a humanizar a marca e a atrair os primeiros utilizadores fiéis.

---

## 📸 Capturas de Ecrã Sugeridas para esta Semana:
1.  **Mockup 3D do Hero**: O topo da página inicial com a imagem premium do currículo de Rui Sardinha.
2.  **O Assistente**: O ecrã onde o utilizador responde a perguntas rápidas ao lado da pré-visualização ao vivo.
...
## 💬 Post 2: WhatsApp (Viral & Grupos)

```text
Família, tudo bem? 🇦🇴🙌

Durante muito tempo ajudei várias pessoas a criar currículos e cartas de apresentação. Vi muita gente aflita por ter excelentes competências, mas não saber por onde começar a escrever no papel. Perdem horas no Canva a lutar com modelos que quebram... é uma dor de cabeça!

Para resolver isso de forma definitiva, criei um sistema inteligente: o *CV Fácil*! 🚀

É a primeira plataforma angolana onde tu não precisas de quebrar a cabeça para estruturar o teu currículo:
👉 Basta responderes a perguntas simples sobre a tua carreira (ou colar o teu CV antigo) que o sistema organiza e monta a melhor estratégia de escrita por ti.
👉 Escolhes um dos nossos templates premium (otimizados para os robôs de recrutamento ATS) e a informação encaixa-se sozinha perfeitamente no modelo.
👉 Exportas em PDF na hora e já está!

A criação e visualização são gratuitas. Testem o sistema e digam-me o que acharam:
🔗 https://cvfacil-ao.vercel.app/

Se puderem partilhar com os vossos kambas e nos vossos grupos de WhatsApp, vão ajudar muita gente a destacar-se no mercado de trabalho! Tamo junto! 🎯🔥
```
